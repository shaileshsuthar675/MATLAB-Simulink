...
MODEL                = slrt_ex_osc_ucf
MODULES              = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c slrt_ex_osc_ucf.c slrt_ex_osc_ucf_data.c rt_main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/slrt_ex_osc_ucf.exe
MAKEFILE             = slrt_ex_osc_ucf.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = slrt_ex_osc_ucf_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slrt_ex_osc_ucf_grt_rtw \
