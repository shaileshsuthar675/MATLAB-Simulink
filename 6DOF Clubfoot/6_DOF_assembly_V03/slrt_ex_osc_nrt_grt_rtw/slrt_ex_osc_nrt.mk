...
MODEL                = slrt_ex_osc_nrt
MODULES              = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c slrt_ex_osc_nrt.c slrt_ex_osc_nrt_data.c rt_main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/slrt_ex_osc_nrt.exe
MAKEFILE             = slrt_ex_osc_nrt.mk
MATLAB_ROOT          = C:/Program Files/Polyspace/R2021a
ALT_MATLAB_ROOT      = C:/PROGRA~1/POLYSP~1/R2021a
START_DIR            = S:/project works/FYP/matlab/test2/6_DOF_~3
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 2
NCSTATES             = 2
BUILDARGS            =  EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 OPTS="-DEXT_MODE -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=1"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = slrt_ex_osc_nrt_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slrt_ex_osc_nrt_grt_rtw \
	-I$(MATLAB_ROOT)/toolbox/slrealtime/examples \
...
rt_main.obj : $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/rtw/c/src/common/rt_main.c
